...
var VanillaModal, qwest, validate;
...
window.app = function() {
  var getPosition, initForm, initGallery, initLink, initMap, initMenu, initScroll, menuOpen;
  menuOpen = false;
  initMap = function() {
  ...
  initLink = function() {
    var addClickEventOnButtons, addClickEventOnLinks, buttons, element, index, links, scrollTo, _i, _j, _len, _len1;
  ...
  initGallery = function() {
    var count, galleryURL, initImage, modal;
  ...
  initForm = function() {
    var apiKey, errorInput, from, mailURL, resetForm, resetInput, subject, validator;
    ...
    document.forms['formDevis'].addEventListener("submit", function() {
      return resetForm();
    });
    ...
    return validator = new FormValidator('formDevis', [
      ...
      var data, error, headers, index, to, _i, _len, _results;
      ...
      if (errors.length > 0) {
        ...
        return qwest.post(mailURL, data, headers).then(function(response) {
...
},{"qwest":1,"validate-js":2,"vanilla-modal":3}]},{},[4])